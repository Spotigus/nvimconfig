...
vim.keymap.set('n', '<leader>cmg', '<Cmd>CMakeGenerate<CR>')
vim.keymap.set('n', '<leader>cmc', '<Cmd>CMakeClean<CR>')
vim.keymap.set('n', '<leader>cmb', '<Cmd>CMakeBuild<CR>')
vim.keymap.set('n', '<leader>cmr', '<Cmd>CMakeRun<CR>')
vim.keymap.set('n', '<leader>cmd', '<Cmd>CMakeClose<CR>')
